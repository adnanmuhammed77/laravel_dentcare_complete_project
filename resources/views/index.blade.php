                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="{{ url('appointment') }}" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Appointment</a>
            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-dark d-flex flex-column p-5" style="height: 300px;">
                        ...
                        <div class="d-flex justify-content-between text-white mb-3">
                            <h6 class="text-white mb-0">Cosmetic Dentistry</h6>
                            
                        </div>
                        <div class="d-flex justify-content-between text-white mb-3">
                            <h6 class="text-white mb-0">Dental Implants</h6>
                           
                        </div>
                        <div class="d-flex justify-content-between text-white mb-3">
                            <h6 class="text-white mb-0">Dental Bridges</h6>
                           
                        </div>
                        <br>
                        
                        <a class="btn btn-light" href="{{ url('service') }}">View More</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <a href="{{ url('appointment') }}" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Make Appointment</a>
                </div>
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6">
                    <div class="appointment-form h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <form action="{{ url('appointmentup') }}" method="post">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="phone" class="form-control bg-light border-0" placeholder="Your phone no" style="height: 55px;">
                                </div>
                                <div class="col-12 col-sm-6">
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-md-6 service-item wow zoomIn" data-wow-delay="0.6s">
                            <div class="rounded-top overflow-hidden">
                                <img class="img-fluid" src="{{ asset('uploads/services/'.$post->image) }}" alt="">
                            </div>
